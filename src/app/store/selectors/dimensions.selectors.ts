...
export const selectDimensions = createSelector(selectDimensionsState, (state) => state.dimensions);

export const selectDimension = (name: string) =>
  createSelector(selectDimensionsState, (state) => state.dimensions[name]);
...
export const selectDimensionError = createSelector(selectDimensionsState, (state) => state.error);
