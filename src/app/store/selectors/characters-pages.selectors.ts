...
export const selectCharactersPagesState = createFeatureSelector<CharactersPagesState>('charactersPages');


export const selectCharactersPage = (page: number, filter: CharacterFilter) => createSelector(
  selectCharactersPagesState,
  (state) => isEqual(state.filter, filter) ? state.pages[page] : undefined
);

export const selectCharactersPageIsLoaded = (page: number, filter: CharacterFilter) => createSelector(
  selectCharactersPagesState,
