...
import { PaginationModel, PAGINATION_INITIAL_STATE } from './episodes-pages.reducer';
...
export const charactersPagesReducer = createReducer(
  ...
  on(CharactersPagesActions.loadCharactersPagesSuccess, (state, { page, characters, totalPages, totalItems, filter }) => {
